...
namespace SharpCraft.Tests.Commands
{
    ...
    public class ParticleCommandsTests
    {
        ...
        public void ParticleNormalCommandTest()
        {
            ...
            Assert.AreEqual("particle barrier ~0 ~0 ~0 2 2 2 1 10", new ParticleNormalCommand(ID.Particle.barrier, new Coords(0, 0, 0), new Coords(2, 2, 2), 1, 10, false, null).GetCommandString());
        ...
        public void ParticleColoredDustTest()
        {
            ...
            Assert.AreEqual("particle dust 1 1 1 3.2 ~0 ~0 ~0 2 3 4 1.2 5", new ParticleColoredDustCommand(new HexColor(255, 255, 255), 3.2, new Coords(0, 0, 0), new Coords(2, 3, 4), 1.2, 5, false, null).GetCommandString());
        ...
        public void ParticleBlockTest()
        {
            ...
            Assert.AreEqual("particle block minecraft:anvil[facing=east] ~0 ~0 ~0 2 2 2 0.2 5", new ParticleBlockCommand(new Block.Anvil(ID.Block.anvil) { SFacing = ID.Facing.east }, new Coords(), new Coords(2, 2, 2), 0.2, 5, false, false, null).GetCommandString());
        ...
        public void ParticleItemTest()
        {
            ...
            Assert.AreEqual("particle item minecraft:stone{CustomModelData:1} ~0 ~0 ~0 2 3 4 0.2 10", new ParticleItemCommand(new Item(ID.Item.stone) { CustomModelData = 1 }, new Coords(), new Coords(2, 3, 4), 0.2, 10, false, null).GetCommandString());
