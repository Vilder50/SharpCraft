...
namespace SharpCraft.Tests.Commands
{
    ...
    public class ParticleCommandsTests
    {
        ...
        {
            Assert.AreEqual("particle barrier ~0 ~0 ~0 2 3 4 1.2 10 force @s", new ParticleNormalCommand(ID.Particle.barrier, new Coords(0, 0, 0), new Coords(2, 3, 4), 1.2, 10, true, ID.Selector.s).GetCommandString());
            Assert.AreEqual("particle barrier ~0 ~0 ~0 2 2 2 1 10 force", new ParticleNormalCommand(ID.Particle.barrier, new Coords(0, 0, 0), new Coords(2, 2, 2), 1, 10, true, null).GetCommandString());
            Assert.AreEqual("particle barrier ~0 ~0 ~0 2.1 2.1 2.1 1 10", new ParticleNormalCommand(ID.Particle.barrier, new Coords(0, 0, 0), new Coords(2.1, 2.1, 2.1), 1, 10, false, null).GetCommandString());
        ...
        {
            Assert.AreEqual("particle dust 0.4980392156862745098039215686 1 0.4980392156862745098039215686 3.2 ~0 ~0 ~0 2 3 4 1.2 5 force @s", new ParticleColoredDustCommand(new HexColor(127, 255, 127), 3.2, new Coords(0, 0, 0), new Coords(2, 3, 4), 1.2, 5, true, ID.Selector.s).GetCommandString());
            Assert.AreEqual("particle dust 1 1 1 3.2 ~0 ~0 ~0 2 3 4 1.2 5 force", new ParticleColoredDustCommand(new HexColor(255, 255, 255), 3.2, new Coords(0, 0, 0), new Coords(2, 3, 4), 1.2, 5, true, null).GetCommandString());
            Assert.AreEqual("particle dust 1 1 1 3.2 ~0 ~0 ~0 2.1 3.1 4.1 1.2 5", new ParticleColoredDustCommand(new HexColor(255, 255, 255), 3.2, new Coords(0, 0, 0), new Coords(2.1, 3.1, 4.1), 1.2, 5, false, null).GetCommandString());
        ...
        {
            Assert.AreEqual("particle falling_dust minecraft:anvil[facing=east] ~0 ~0 ~0 2 2 2 0.2 5 force @s", new ParticleBlockCommand(new Block.Anvil(ID.Block.anvil) { SFacing = ID.Facing.east }, new Coords(), new Coords(2, 2, 2), 0.2, 5, true, true, ID.Selector.s).GetCommandString());
            Assert.AreEqual("particle falling_dust minecraft:anvil[facing=east] ~0 ~0 ~0 2 2 2 0.2 5 force", new ParticleBlockCommand(new Block.Anvil(ID.Block.anvil) { SFacing = ID.Facing.east }, new Coords(), new Coords(2, 2, 2), 0.2, 5, true, true, null).GetCommandString());
            Assert.AreEqual("particle falling_dust minecraft:anvil[facing=east] ~0 ~0 ~0 2 2 2 0.2 5", new ParticleBlockCommand(new Block.Anvil(ID.Block.anvil) { SFacing = ID.Facing.east }, new Coords(), new Coords(2, 2, 2), 0.2, 5, true, false, null).GetCommandString());
            Assert.AreEqual("particle block minecraft:anvil[facing=east] ~0 ~0 ~0 2.1 2.1 2.1 0.2 5", new ParticleBlockCommand(new Block.Anvil(ID.Block.anvil) { SFacing = ID.Facing.east }, new Coords(), new Coords(2.1, 2.1, 2.1), 0.2, 5, false, false, null).GetCommandString());
        ...
        {
            Assert.AreEqual("particle item minecraft:stone{CustomModelData:1} ~0 ~0 ~0 2 3 4 0.2 10 force @s", new ParticleItemCommand(new Item(ID.Item.stone) {CustomModelData = 1 }, new Coords(), new Coords(2, 3, 4), 0.2 , 10, true, ID.Selector.s).GetCommandString());
            Assert.AreEqual("particle item minecraft:stone{CustomModelData:1} ~0 ~0 ~0 2 3 4 0.2 10 force", new ParticleItemCommand(new Item(ID.Item.stone) { CustomModelData = 1 }, new Coords(), new Coords(2, 3, 4), 0.2, 10, true, null).GetCommandString());
            Assert.AreEqual("particle item minecraft:stone{CustomModelData:1} ~0 ~0 ~0 2.1 3.1 4.1 0.2 10", new ParticleItemCommand(new Item(ID.Item.stone) { CustomModelData = 1 }, new Coords(), new Coords(2.1, 3.1, 4.1), 0.2, 10, false, null).GetCommandString());
