...
namespace SharpCraft.Tests.MiscObjects
{
    ...
    public class JsonTextTests
    {
        ...
        public void TestHoverEvents()
        {
            ...
            //item
            Assert.AreEqual("\"hoverEvent\":{\"action\":\"show_item\",\"contents\":{\"id\":\"minecraft:stone\",\"tag\":\"{CanPlaceOn:[\\\"minecraft:dirt\\\"]}\",\"count\":1}}", new JsonText.ItemHoverEvent(new Item(ID.Item.stone, 1) { CanPlaceOn = new IBlockType[] { ID.Block.dirt } }).GetEventString(), "ItemHoverEvent doesn't return correct string");
