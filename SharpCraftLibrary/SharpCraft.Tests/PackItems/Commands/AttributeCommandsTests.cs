...
namespace SharpCraft.Tests.Commands
{
    ...
    public class AttributeCommandsTests
    {
        ...
        {
            Assert.AreEqual("attribute @s minecraft:generic.armor_toughness get 2.3", new AttributeGetCommand(ID.Selector.s, ID.AttributeType.generic_armor_toughness, 2.3).GetCommandString());
            Assert.AreEqual("attribute @s minecraft:generic.armor_toughness get", new AttributeGetCommand(ID.Selector.s, ID.AttributeType.generic_armor_toughness, 1).GetCommandString());
        ...
        {
            Assert.AreEqual("attribute @s minecraft:generic.armor_toughness base get 2.3", new AttributeGetBaseCommand(ID.Selector.s, ID.AttributeType.generic_armor_toughness, 2.3).GetCommandString());
            Assert.AreEqual("attribute @s minecraft:generic.armor_toughness base get", new AttributeGetBaseCommand(ID.Selector.s, ID.AttributeType.generic_armor_toughness, 1).GetCommandString());
        ...
        {
            Assert.AreEqual("attribute @s minecraft:generic.armor_toughness base set 1", new AttributeSetBaseCommand(ID.Selector.s, ID.AttributeType.generic_armor_toughness, 1).GetCommandString());
        ...
        {
            Assert.AreEqual("attribute @s minecraft:generic.armor_toughness modifier add 00000000-0000-0000-0000-000000000000 test 1.1 multiply", new AttributeAddModifierCommand(ID.Selector.s, ID.AttributeType.generic_armor_toughness, new UUID(0, 0), "test", 1.1, ID.AttributeOperation.multiply_total).GetCommandString());
            Assert.AreEqual("attribute @s minecraft:generic.armor_toughness modifier add 00000000-0000-0001-0000-000000000001 test 1 addition", new AttributeAddModifierCommand(ID.Selector.s, ID.AttributeType.generic_armor_toughness, new UUID(1, 1), "test", 1, ID.AttributeOperation.addition).GetCommandString());
        ...
        {
            Assert.AreEqual("attribute @s minecraft:generic.armor_toughness modifier remove 00000000-0000-0001-0000-000000000001", new AttributeRemoveModifierCommand(ID.Selector.s, ID.AttributeType.generic_armor_toughness, new UUID(1, 1)).GetCommandString());
        ...
        {
            Assert.AreEqual("attribute @s minecraft:generic.armor_toughness modifier value get 00000000-0000-0001-0000-000000000001 1.1", new AttributeGetModifierCommand(ID.Selector.s, ID.AttributeType.generic_armor_toughness, new UUID(1, 1), 1.1).GetCommandString());
            Assert.AreEqual("attribute @s minecraft:generic.armor_toughness modifier value get 00000000-0000-0001-0000-000000000001", new AttributeGetModifierCommand(ID.Selector.s, ID.AttributeType.generic_armor_toughness, new UUID(1, 1), 1).GetCommandString());
