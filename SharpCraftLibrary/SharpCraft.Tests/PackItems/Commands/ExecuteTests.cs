...
namespace SharpCraft.Tests.Commands
{
    ...
    public class ExecuteTests
    {
        ...
        public void TestExecuteGetCommandString()
        {
            ...
            Assert.AreEqual("execute if score @s test matches 1..5", new ExecuteIfScoreMatches(new SharpCraft.Selector(), new ScoreObject("test"), new Range(1,5)).GetCommandString(), "ExecuteIfScoreMatches does not return correct GetCommandString");
            Assert.AreEqual("execute if score @s test > @s test", new ExecuteIfScoreRelative(new SharpCraft.Selector(), new ScoreObject("test"), ID.IfScoreOperation.Higher, new SharpCraft.Selector(), new ScoreObject("test")).GetCommandString(), "ExecuteIfScoreRelative does not return correct GetCommandString");
            ...
            Assert.AreEqual("execute store result score @s test", new ExecuteStoreScore(new SharpCraft.Selector(), new ScoreObject("test")).GetCommandString(), "ExecuteStoreScore does not return correct GetCommandString");
