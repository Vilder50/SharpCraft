...
namespace SharpCraft.Tests.Commands
{
    ...
    public class ExecuteTests
    {
        ...
        public void TestExecuteGetCommandString()
        {
            ...
            Assert.AreEqual("execute if entity @s[level=1..2]", new ExecuteIfEntity(new SharpCraft.Selector() { Level = new MCRange(1, 2) }).GetCommandString(), "ExecuteIfEntity does not return correct GetCommandString");
            Assert.AreEqual("execute if score @s test matches 1..5", new ExecuteIfScoreMatches(new SharpCraft.Selector(), new Objective("test"), new MCRange(1,5)).GetCommandString(), "ExecuteIfScoreMatches does not return correct GetCommandString");
            ...
            Assert.AreEqual("execute positioned as @s[level=1..2]", new ExecutePositionedAs(new SharpCraft.Selector() { Level = new MCRange(1, 2) }).GetCommandString(), "ExecutePositionedAs does not return correct GetCommandString");
            ...
            Assert.AreEqual("execute rotated as @s[level=1..2]", new ExecuteRotatedAs(new SharpCraft.Selector() { Level = new MCRange(1, 2) }).GetCommandString(), "ExecuteRotatedAs does not return correct GetCommandString");
            ...
            Assert.AreEqual("execute store success bossbar minecraft:test value", new ExecuteStoreBossbar(new BossBar("test"), true, false).GetCommandString(), "ExecuteStoreBossbar does not return correct GetCommandString");
