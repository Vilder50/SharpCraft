...
namespace SharpCraft.Tests.Commands
{
    ...
    public class ExecuteTests
    {
        ...
        public void TestExecuteGetCommandString()
        {
            ...
            Assert.AreEqual("execute as @s[level=1..2]", new ExecuteAs(new SharpCraft.Selector() { Level = new Range(1, 2) }).GetCommandString(), "ExecuteAs does not return correct GetCommandString");
            Assert.AreEqual("execute at @s[level=1..2]", new ExecuteAt(new SharpCraft.Selector() { Level = new Range(1, 2) }).GetCommandString(), "ExecuteAt does not return correct GetCommandString");
            ...
            Assert.AreEqual("execute facing entity @s[level=1..2] feet", new ExecuteFacingEntity(new SharpCraft.Selector() { Level = new Range(1, 2) }, ID.FacingAnchor.feet).GetCommandString(), "ExecuteFacingEntity does not return correct GetCommandString");
            Assert.AreEqual("execute if block ~ ~ ~ minecraft:anvil[facing=north]", new ExecuteIfBlock(new Coords(), new Block.Anvil(ID.Block.anvil) {SFacing = ID.Facing.north }).GetCommandString(), "ExecuteIfBlock does not return correct GetCommandString");
            Assert.AreEqual("execute if data block ~ ~ ~ test.data", new ExecuteIfData(new BlockDataLocation(new Coords(), "test.data")).GetCommandString(), "ExecuteIfData does not return correct GetCommandString");
            Assert.AreEqual("execute unless blocks ~1 ~1 ~1 ~2 ~2 ~2 3 3 3 masked", new ExecuteIfBlocks(new Coords(1,1,1), new Coords(2,2,2), new Coords(false, 3, 3, 3), true, false).GetCommandString(), "ExecuteIfBlocks does not return correct GetCommandString");
            Assert.AreEqual("execute if blocks ~1 ~1 ~1 ~2 ~2 ~2 3 3 3 all", new ExecuteIfBlocks(new Coords(1, 1, 1), new Coords(2, 2, 2), new Coords(false, 3, 3, 3), false, true).GetCommandString(), "ExecuteIfBlocks does not return correct GetCommandString");
            Assert.AreEqual("execute if entity @s[level=1..2]", new ExecuteIfEntity(new SharpCraft.Selector() { Level = new Range(1, 2) }).GetCommandString(), "ExecuteIfEntity does not return correct GetCommandString");
            Assert.AreEqual("execute if score @s test matches 1..5", new ExecuteIfScoreMatches(new SharpCraft.Selector(), new Objective("test"), new Range(1,5)).GetCommandString(), "ExecuteIfScoreMatches does not return correct GetCommandString");
            Assert.AreEqual("execute if score @s test > @s test", new ExecuteIfScoreRelative(new SharpCraft.Selector(), new Objective("test"), ID.IfScoreOperation.Higher, new SharpCraft.Selector(), new Objective("test")).GetCommandString(), "ExecuteIfScoreRelative does not return correct GetCommandString");
            Assert.AreEqual("execute positioned ~ ~ ~", new ExecutePosition(new Coords()).GetCommandString(), "ExecutePosition does not return correct GetCommandString");
            Assert.AreEqual("execute positioned as @s[level=1..2]", new ExecutePositionedAs(new SharpCraft.Selector() { Level = new Range(1, 2) }).GetCommandString(), "ExecutePositionedAs does not return correct GetCommandString");
            ...
            Assert.AreEqual("execute rotated as @s[level=1..2]", new ExecuteRotatedAs(new SharpCraft.Selector() { Level = new Range(1, 2) }).GetCommandString(), "ExecuteRotatedAs does not return correct GetCommandString");
            Assert.AreEqual("execute store result block ~ ~ ~ test.data double 100.3335", new ExecuteStoreBlock(new Coords(), "test.data", ID.StoreTypes.Double, 100.3335).GetCommandString(), "ExecuteStoreBlock does not return correct GetCommandString");
            ...
            Assert.AreEqual("execute store result entity @s cake long 10", new ExecuteStoreEntity(new SharpCraft.Selector(), "cake", ID.StoreTypes.Long, 10).GetCommandString(), "ExecuteStoreEntity does not return correct GetCommandString");
        ...
        {
            //setup
            BaseExecuteCommand command1 = new ExecuteAt(new SharpCraft.Selector()) { ExecuteCommand = new ExecuteAlign(true, true, true) };
            BaseExecuteCommand command2 = new ExecuteAt(new SharpCraft.Selector()) { ExecuteCommand = new ExecuteAlign(true, true, true) };
        ...
        {
            //setup
            BaseExecuteCommand command1 = new ExecuteAt(new SharpCraft.Selector()) { ExecuteCommand = new ExecuteAlign(true, true, true) { ExecuteCommand = new SayCommand("hello") } };
            BaseExecuteCommand command2 = new ExecuteAt(new SharpCraft.Selector()) { ExecuteCommand = new ExecuteAlign(true, true, true) { ExecuteCommand = new ExecuteAs(ID.Selector.a) } };
