...
namespace SharpCraft.Tests.PackItems
{
    ...
    public class RecipeTests
    {
        ...
        {
            Assert.AreEqual("name:reci", new FileMocks.MockRecipe(MockDatapack.GetPack().Namespace("name"), "reci").GetNamespacedName(), "EmptyRecipe doesn't reutrn correct string");
