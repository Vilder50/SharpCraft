...
namespace SharpCraft.Tests.PackItems
{
    ...
    public class GroupTests
    {
        ...
        {
            Assert.AreEqual("#space:file", new FileMocks.MockGroup<IBlockType>(EmptyDatapack.GetPack().Namespace("space"), "file").GetNamespacedName(), "EmptyGroup doesn't return correct string");
        }
