...
namespace SharpCraft
{
    ...
    /// <summary>
    /// Class for structures which should be placeable.
    /// </summary>
    public class EmptyStructure : IStructure
    {
        /// <summary>
        /// Intializes a new <see cref="EmptyStructure"/>
        /// </summary>
        /// <param name="packNamespace">The namespace the structure is in</param>
        /// <param name="name">The name of the structure</param>
        public EmptyStructure(BasePackNamespace packNamespace, string name)
        {
            FileId = name;
        ...
        /// <summary>
        /// Returns the string used for placing this structure
        /// </summary>
        /// <returns>The string used for placing this structure</returns>
        ...
        /// <summary>
        /// Converts a string of the format NAMESPACE:FUNCTION into an <see cref="EmptyStructure"/>
        /// </summary>
        /// <param name="structure">The string to convert</param>
        public static implicit operator EmptyStructure(string structure)
        {
            ...
            return new EmptyStructure(EmptyDatapack.GetPack().Namespace(parts[0]), parts[1]);
        }
