...
namespace SharpCraft
{
    ...
    public class SpecialRecipe : BaseRecipe
    {
        ...
        public SpecialRecipe(BasePackNamespace packNamespace, string fileName, SpecialType recipeType, string group = null, WriteSetting writeSetting = WriteSetting.LockedAuto) : base(packNamespace, fileName, group, writeSetting, "crafting_special_" + recipeType.ToString())
        {
            EndConstructor();
        }
