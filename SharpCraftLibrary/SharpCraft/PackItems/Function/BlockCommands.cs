namespace SharpCraft
{
    public partial class Function
    {
        ...
        public class BlockCommands
        {
            ...
            internal BlockCommands(FunctionWriter commandsList)
            {
                writer = commandsList;
            ...
            {
                FunctionWriter writer;
                internal ClassData(FunctionWriter commandsList)
                {
                    writer = commandsList;
                }
                ...
                {
                    writer.Add($"data modify block {toBlock} {toDataPath} insert {(index > 0 ? "after" : "before")} {System.Math.Abs(index)} value {copyData}");
                    writer.NewLine();
                }
                ...
                {
                    writer.Add($"data modify entity {toBlock} {toDataPath} insert {(index > 0 ? "after" : "before")} {System.Math.Abs(index)} from block {fromBlock} {fromDataPath}");
                    writer.NewLine();
                }
                ...
                {
                    writer.Add($"data modify entity {toBlock} {toDataPath} insert {(index > 0 ? "after" : "before")} {System.Math.Abs(index)} from entity {fromSelector} {fromDataPath}");
                    writer.NewLine();
                }
            }
        }
