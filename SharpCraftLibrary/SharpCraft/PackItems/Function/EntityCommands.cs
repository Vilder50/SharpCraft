namespace SharpCraft
{
    public partial class Function
    {
        ...
        public class EntityCommands
        {
            ...
            internal EntityCommands(FunctionWriter CommandsList)
            {
                Writer = CommandsList;
            ...
            public class ClassTag
            {
                ...
                FunctionWriter Writer;
                internal ClassTag(FunctionWriter CommandsList)
                {
                    Writer = CommandsList;
                }
            ...
            {
                FunctionWriter Writer;
                internal ClassScore(FunctionWriter CommandsList)
                {
                    Writer = CommandsList;
                }
            ...
            {
                FunctionWriter Writer;
                internal ClassEffect(FunctionWriter CommandsList)
                {
                    Writer = CommandsList;
                }
            ...
            public class ClassItem
            {
                ...
                {
                    FunctionWriter Writer;
                    internal ClassHorse(FunctionWriter commandsList)
                    {
                        Writer = commandsList;
                    }
