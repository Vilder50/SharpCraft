namespace SharpCraft
{
    public partial class Function
    {
        ...
        public class PlayerCommands
        {
            ...
            {
                FunctionWriter Writer;
                internal ClassXP(FunctionWriter CommandsList)
                {
                    Writer = CommandsList;
                }
                /// <summary>
            ...
            internal PlayerCommands(FunctionWriter CommandsList)
            {
                Writer = CommandsList;
            ...
            {
                Writer.Add("trigger " + scoreObject + " " + (set ? "set" : "add"));
            }
            ...
            {
                FunctionWriter Writer;
                internal ClassParticle(FunctionWriter CommandsList)
                {
                    Writer = CommandsList;
                }
            ...
            {
                FunctionWriter Writer;
                internal ClassItem(FunctionWriter CommandsList)
                {
                    Writer = CommandsList;
                }
            ...
            {
                FunctionWriter Writer;
                internal ClassSound(FunctionWriter CommandsList)
                {
                    Writer = CommandsList;
                }
            ...
            {
                FunctionWriter Writer;
                internal ClassTitle(FunctionWriter CommandsList)
                {
                    Writer = CommandsList;
                }
            ...
            {
                FunctionWriter Writer;
                internal ClassRecipe(FunctionWriter CommandsList)
                {
                    Writer = CommandsList;
                }
            ...
            {
                FunctionWriter Writer;
                internal ClassAdvancement(FunctionWriter CommandsList)
                {
                    Writer = CommandsList;
                }
                /// <summary>
