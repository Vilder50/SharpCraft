...
namespace SharpCraft.Items
{
    ...
    public class FireworkRocket : Item
    {
        ...
        public new static Data.DataPathCreator<FireworkRocket> PathCreator => new Data.DataPathCreator<FireworkRocket>();
        ...
        public FireworkRocket(IItemType? ItemID, sbyte? Count = null, sbyte? Slot = null) : base(ItemID, Count, Slot) { }
