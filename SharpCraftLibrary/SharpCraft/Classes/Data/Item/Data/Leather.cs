...
namespace SharpCraft.Items
{
    ...
    public class Leather : Item
    {
        ...
        public new static Data.DataPathCreator<Leather> PathCreator => new Data.DataPathCreator<Leather>();
        ...
        public Leather(IItemType? ItemID, sbyte? Count = null, sbyte? Slot = null) : base(ItemID, Count, Slot) { }
