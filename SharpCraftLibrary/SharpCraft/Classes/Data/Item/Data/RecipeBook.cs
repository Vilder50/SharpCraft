...
namespace SharpCraft.Items
{
    ...
    public class RecipeBook : Item
    {
        ...
        public new static Data.DataPathCreator<RecipeBook> PathCreator => new Data.DataPathCreator<RecipeBook>();
        ...
        public RecipeBook(IItemType? ItemID, sbyte? Count = null, sbyte? Slot = null) : base(ItemID, Count, Slot) { }
