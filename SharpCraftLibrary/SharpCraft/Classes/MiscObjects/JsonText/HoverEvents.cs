...
namespace SharpCraft.JsonText
{
    ...
    public abstract class BaseHoverEvent
    {
        ...
        /// <summary>
        /// Returns the string for this hover event used in <see cref="BaseJsonText"/>
        /// </summary>
        ...
        /// <summary>
        /// Converts a <see cref="BaseJsonText"/> into a <see cref="BaseHoverEvent"/> object
        /// </summary>
        /// <param name="text">the <see cref="BaseJsonText"/> to convert</param>
        public static implicit operator BaseHoverEvent(BaseJsonText text)
        {
